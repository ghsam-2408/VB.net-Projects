                ...
                Using command As New OleDbCommand(searchQuery, connection)
                    ...
                    Using reader As OleDbDataReader = command.ExecuteReader()
                        If reader.Read() Then
                            ...
                            Return True
                        Else
                            ' Student not found - provide guidance
                            txtEmail.Clear()

                            Dim result As DialogResult = MessageBox.Show(
                                $"Student with ID '{studentID}' not found in the enrollment system." & vbCrLf & vbCrLf &
                                "The student needs to be enrolled first before making payments." & vbCrLf & vbCrLf &
                                "Would you like to open the Students Enrollment form to enroll this student?",
                                "Student Not Found - Enrollment Required",
                                MessageBoxButtons.YesNo,
                                MessageBoxIcon.Question)

                            If result = DialogResult.Yes Then
                                ' Open StudentsEnrollment form
                                Try
                                    StudentsEnrollment.Show()
                                    MessageBox.Show("Students Enrollment form opened. Please enroll the student and then return to process payment.",
                                                  "Enrollment Form Opened", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                Catch ex As Exception
                                    MessageBox.Show($"Error opening Students Enrollment form: {ex.Message}",
